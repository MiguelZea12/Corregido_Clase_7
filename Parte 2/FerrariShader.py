...
class FerrariShader(PyOGLApp):
    ...
    def initialise(self):
        ...
        self.ferrari = LoadMesh("models/ferrari.obj", "images/square_tex.jpg", draw_type=GL_QUADS,
                             location=pygame.Vector3(0, 0, 0),
                             scale=pygame.Vector3(0.006, 0.006, 0.006),
    ...
    def display(self):
        ...
        self.ferrari.draw(self.camera, self.lights)

        # glDrawArrays(GL_LINE_LOOP, 0, self.vertex_count)


FerrariShader().mainloop()
